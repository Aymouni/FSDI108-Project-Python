...
We can pass data to function (paramerters), and they can return data.
...
print_full_name("Aymen", "Saad", "N")

# Functions that return values
# Instead of just prining, functions can send back (return) data.

def get_full_name(fname, lname):
    return  f"{fname, lname}"   # Sends back the full name as text

# Store the returned value in a variable
full_name = get_full_name("Aymen", "Saad")
print(full_name)

# functions with default parameters
# A default parameter means the function will use that value
# If no arguement is porvided when calling the function
